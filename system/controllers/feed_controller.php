...
class Feed_controller {
    public function render_post($user_avatar_path, $post_author, $post_author_group, $post_author_rating,
            ...
            <div class="main-post-container">
                <div class="text-post-container">
                    <div class="meta-post-container">
                        ...
                        <p class="post-author-rating">['.$post_author_group.'] '.$post_author_rating. '</p>
